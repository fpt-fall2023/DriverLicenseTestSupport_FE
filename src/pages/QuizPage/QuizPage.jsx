        ...
        <Col span={22}>
          <div style={{ marginLeft: '20%' }}>
            ...
            <Typography.Text style={{ fontSize: '18px', color: 'black' }}>
              Dựa theo cấu trúc đề thi lý thuyết B2 chính thức thì mỗi đề thi
              sát hạch lý thuyết B2 sẽ bao gồm:
              <Text italic style={{ fontSize: '18px' }}>
                ...
                hình kèm theo 1 câu hỏi điểm liệt (tình huống gây mất an toàn
            ...
            <Typography.Paragraph style={{ fontSize: 18, color: 'black' }}>
              <p>
                <strong>Lưu ý:</strong> Bộ đề thi bằng lái xe B2 này được xây
                dựng theo tài liệu 600 câu hỏi thi ô tô Tổng Cục Đường Bộ VN ban
                hành. Nếu học thuộc hết 18 đề thi thử bằng lái xe B2 này đồng
                nghĩa với việc bạn sẽ nắm chắc việc thi đậu lý thuyết 100% mà

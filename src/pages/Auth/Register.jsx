  ...
  return (
    <div className={styles.login}>
      ...
      <div className={styles.loginBox}>
        ...
        />
        <div className={styles.loginBox__title}>
          Chào Mừng Tới Ôn Tập Lái Xe
        </div>
        <div className={styles.loginBox__subtitle}>
          Đồng hành cùng bạn trên con đường an toàn
        </div>
        <Form {...mainLayout} form={form} onFinish={onFinish}>
          ...
          <Form.Item
            name="password"
            rules={[{ required: true, message: 'Nhập password của bạn' }]}
          >
        ...
        <div style={{ fontWeight: 'bold' }}>Đăng Ký Bằng Google:</div>
        <div>
          <img
            src="src/assets/images/google.png"
            alt="google_login"
            className={styles.loginBox__social}
          />
        </div>
        <div className={styles.loginBox__line}></div>
